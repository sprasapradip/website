...
<div class="container"> 
  ...
  <span id="printout">
  <h3 align="center">Bakeshop</h3>
      <h4 align="center">Ratnanagar Shop<br/>
      Chitwan<br/>
      </h4>
            ...
            <tr>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td>&#8360.  <output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output></td>
                        </tr>
              <?php
                        }
              ...
              <?php 
                  $query = "SELECT * FROM `tpayment` p ,`tcustomer` c 
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  <!-- <div>Total Price : &#8360.  <?php echo number_format($tot,2);?></div> -->
                  <!-- <div>Delivery Fee : &#8360.  <?php echo number_format($price,2); ?></div> -->
                  <div>Overall Price : &#8360.  <?php echo number_format($cur->TOTALPRICE,2); ?></div>
                </div>
              </div>
              <div class="row" style="margin-left:2%"> 
                <p>We hope you enjoy your purchased products. Have a nice day!</p>
                <p>Sincerely.</p>
                <h4>Pradip Subedi G-SHOP</h4>
            </div>
