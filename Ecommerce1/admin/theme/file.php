...
<link href="<?php echo web_root; ?>admin/css/ekko-lightbox.css" rel="stylesheet">
  ...
  <?php
    $query = "SELECT * FROM tabledata WHERE ORDERING = 'Pending'";
    $mydb->setQuery($query);
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >G-SHOP</a>
            </div>
            <!-- /.navbar-header -->
...
<script type="text/javascript" src="<?php echo web_root; ?>js/local/bootstrap-datetimepicker-ne.js" charset="UTF-8"></script>
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;">Copyright &copy; Engineering Student </p></footer>
</html>