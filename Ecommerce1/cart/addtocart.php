  ...
  <?php check_message(); ?>
      <div class="">
        <div class="panel panel-default">
          ...
          <div>Every products has a mininum price of &#8360.  110.00 each to be able to order.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
              ...
              if (!empty($_SESSION['fixnmix_cart'])){ 
                ...
                echo '<script>totalprice();</script>';
                    ...
                    $query = "SELECT * FROM `tproducts` p , `tcategory` c 
            ...
            ?>
                      <tr>
                        ...
                        <td>&#8360.  <?php echo number_format($result->PRICE,2) ?></td>
                        ...
                        <td>&#8360.  <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : &#8360.  <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
                    ...
                    <div class="tab-content"> 
                      ...
                      <form action="login.php"  onsubmit="return validatepasswords()"  method="post">
                          <div class="modal-body">
                              ...
                              <p align="left">&copy; G-Shop Ordaring system</p>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <!-- <input type="checkbox" name="condition" value="checkbox" /> -->
                      <small>Agree the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of this G-SHOP</small>
                      
                      </div>
                    </div>
                  </div>
 
                  <div class="modal-footer"><p align="left">&copy; G-SHOP </p>
                    <button class="btn btn-default" data-dismiss="modal" type=
                    "button">Close</button> 
