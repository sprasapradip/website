...
<?php
   if(isset($_POST['btnorder'])){
    ...
    $sql = "SELECT * FROM `tproduct` WHERE `PROID` ='" . $pid. "'";
                ...
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <body onload=" totalprice(); ">
                              ...
                              if (!empty($_SESSION['fixnmix_cart'])){ 
                                ...
                                for ($i=0; $i < $count_cart  ; $i++) { 
                                     ...
                                     //  echo 'for qty'.  $_SESSION['cart'][$i]['qty'].'<br/>';
                                       ...
                                       $query = "SELECT * FROM tproducts p, tcategory o 
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <!-- <div style="float: right; width:100px"></div> -->
                                     <div style="float: left; width:50px">&nbsp;&nbsp;&#8360. <span id="price1"><?php echo $result->PRICE; ?></span></div>
                                     <div  id="test" style="float: right; width:50px">&#8360. <output name="TOTAL" for="QTY price"></output></div>                                     
                                  </div>
                              </form> 
                            ...
                            <tr >  
                            <td>                               
                             <div class="culomn4"><div style="float: right;"><h1> Total Price : &#8360. <span id="sum">0</span></h1></div></div>
                            </td>                        
