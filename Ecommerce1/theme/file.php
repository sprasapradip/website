...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +977 9805151362</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> sprasapradip@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                <li><a href="https://facebook.com/sprasapradip"><i class="fa fa-facebook"></i></a></li>
                <li><a href="https://facebook.com/sprasapradip"><i class="fa fa-twitter"></i></a></li>
                <li><a href="https://facebook.com/sprasapradip"><i class="fa fa-linkedin"></i></a></li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Site by <span><a href="https://sprasamedia.com/">Sprasa Media</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://www.github.com/sprasapradip">Pradip Subedi</a></span></p>
        </div>
      </div>
    </div>
