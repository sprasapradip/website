      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>&#8360.  <?php echo  $result->PRODISPRICE ?></td>
                          <td>&#8360.  <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   &#8360.  <span id="sum">0.00</span></div>
                   <div > Delivery Fee : &#8360.  <span id="fee">0.00</span></div>
                   <div> Overall Price : &#8360.  <span id="overall"><?php echo $tot ;?></span></div>
