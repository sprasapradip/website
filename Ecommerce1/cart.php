...
?>
                             ...
                             <?php
                              ...
                              if (!empty($_SESSION['gcCart'])){ 
                                ...
                                for ($i=0; $i < $count_cart  ; $i++) { 
                                       ...
                                       $query = "SELECT * FROM `tpromopro` pr , `tproduct` p , `tcategory` c
             ...
             ';
                                  ...
                                  &#8360.   <?php echo  $result->PRODISPRICE ; ?>
                                  </td>
                                  <td class="input-group custom-search-form" >
                                     ...
                                     <td> &#8360.  <output id="Osubtot<?php echo $result->PROID ?>"><?php echo   $_SESSION['gcCart'][$i]['price'] ; ?></output></td>
                                </tr>
                        ...
                        <h3 align="right"> Total  &#8360. <span id="sum">0</span></h3> 
    </div>
  </div>  
