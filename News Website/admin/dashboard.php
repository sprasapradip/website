            ...
            <div class="col-md-4">
               <div class="card-box h-100">
                  <div class="card-header">
                     <h2 class="card-title mb-2">Welcome Pradip Subedi</h2>
                     <span class="d-block mb-4 text-nowrap">Website Developer</span>
                  </div>
                  <br><br>
                  ...
                  <div class="card-body">
                     <div class="row ">
                        <div class="col-md-6">
                           ...
                           <small class="d-block mb-3">In <br>Web Development...</small>
                           <br>
                           <br>
                           <a href="https://www.github.com/sprasapradip" target="a_blank" class="btn btn-sm btn-primary">GitHub</a>
                        </div>
                        <div class="col-md-6">
                           <img src="assets/images/price_sprasamedia.png" width="140" height="150" class="rounded-start">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-md-4">
               <div class="card-box h-100">
                  <div class="card-body">
                     <div class="row ">
                        <div class="card-header">
                           <h4 class="card-title m-0">visits 2023</h4>
                        </div>
                        <div id="chart">
